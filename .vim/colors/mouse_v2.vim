...
" Name:       mouse.vim
" Version:    0.1
" Maintainer:	Mizux (mizux.dev@gmail.com), modified by bot-boi
...
let s:indigo          = { "gui": "#5f00ff", "cterm": "57"  }
...
" Keyword
call s:h("Statement", {"fg": s:dark_grey, "gui": "bold", "cterm": "bold"}) " if for while
...
" Types
call s:h("Type",      {"fg": s:purple, "gui": "bold", "cterm": "bold"}) " void bool char int
hi! link Typedef      Type
call s:h("Structure", {"fg": s:fg, "gui": "bold", "cterm": "bold"}) " class struct
...
call s:h("Number",   {"fg": s:light_sky})
call s:h("Float",    {"fg": s:light_sky})
call s:h("String",   {"fg": s:light_sky})
...
call s:h("Comment",        {"fg": s:light_purple, "gui": "italic", "cterm": "italic"})
call s:h("SpecialComment", {"fg": s:purple, "gui": "bold", "cterm": "bold"})
call s:h("pythonDocstring",{"fg": s:white, "bg": s:dark_grey})
